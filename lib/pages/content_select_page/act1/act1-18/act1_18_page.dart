                ...
                children: [
                  ...
                  IndexedStackChild(
                    child: const StatementSceneWidget(
                        ...
                        statement: '각하가 저격당하셨다. 조치를 취해야 한다. <r>남산</r>으로 가자!',
                        name: '김재규'),
                  ),
                  IndexedStackChild(
                    child: const StatementSceneWidget(
                  ...
                  IndexedStackChild(
                    child: const StatementSceneWidget(
                        rightPerson: 'assets/character/kimjaegyu1.png',
                        leftPerson: 'assets/character/jungseunghwa.png',
                        statement: '참모총장은 얼떨떨해하는 와중에 사탕을 몰래 차 바닥에 버려 버린다.',
                        name: ''),
                  ),
                  IndexedStackChild(
                    child: const StatementSceneWidget(
                  ...
                  IndexedStackChild(
                    child: const StatementSceneWidget(
                        rightPerson: 'assets/character/kimjaegyu1.png',
                        leftPerson: 'assets/character/jungseunghwa.png',
                        statement: '상념에 빠졌는지 <b>김재규</b> 부장은 잠시 멍하게 있고,',
                        name: ''),
                  ),
                  IndexedStackChild(
                    child: const StatementSceneWidget(
